...
| `GET` | `/api/market/backtest` | `src/services/apexNextMarketRoutes.ts:3159` | yes |
| `POST` | `/api/market/backtest/production-input` | `src/services/apexNextMarketRoutes.ts:3348` | yes |
...
| `GET` | `/api/market/majors` | `src/services/apexNextMarketRoutes.ts:3322` | yes |
...
| `GET` | `/api/strategies/:strategyId` | `src/services/apexNextMarketRoutes.ts:2776` | yes |
| `POST` | `/api/strategies/:strategyId/fusion-preview` | `src/services/apexNextMarketRoutes.ts:2794` | yes |
| `GET` | `/api/strategies/:strategyId/optimization` | `src/services/apexNextMarketRoutes.ts:2879` | yes |
| `POST` | `/api/strategies/:strategyId/optimization/promote` | `src/services/apexNextMarketRoutes.ts:3036` | yes |
| `POST` | `/api/strategies/:strategyId/optimization/rollback` | `src/services/apexNextMarketRoutes.ts:3076` | yes |
| `POST` | `/api/strategies/:strategyId/optimize` | `src/services/apexNextMarketRoutes.ts:2900` | yes |
| `POST` | `/api/strategies/:strategyId/validate` | `src/services/apexNextMarketRoutes.ts:3095` | yes |
| `POST` | `/api/strategies/autopilot/control` | `src/services/apexNextMarketRoutes.ts:2446` | yes |
| `POST` | `/api/strategies/autopilot/cycle` | `src/services/apexNextMarketRoutes.ts:2412` | yes |
| `GET` | `/api/strategies/autopilot/status` | `src/services/apexNextMarketRoutes.ts:1734` | yes |
| `POST` | `/api/strategies/multi-backtest` | `src/services/apexNextMarketRoutes.ts:2576` | yes |
| `POST` | `/api/strategies/paper-multi-trade/size` | `src/services/apexNextMarketRoutes.ts:2741` | yes |
...
| `GET` | `/api/system/health` | `src/services/apexNextMarketRoutes.ts:3331` | yes |
