...
check('local proxy recovery enabled', proxyFetch.includes("process.env.PROXY_MODE || 'auto'") && proxyFetch.includes('APEX_AUTO_LOCAL_PROXY_PORT') && proxyFetch.includes('APEX_AUTO_LOCAL_PROXY_SCHEME') && proxyFetch.includes('socks5h://127.0.0.1:${autoPort}'));
